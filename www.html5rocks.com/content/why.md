...
HTML5 technologies—JavaScript, CSS, and HTML— are easier to learn for a larger number of developers. JavaScript is dynamic and adaptable, working in a large number of environments. 
